        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-gray-700 mb-8 max-w-3xl">
              Центр Безопасности данных имеет все необходимые лицензии ФСТЭК России и ФСБ России для оказания полного спектра услуг в области технической защиты информации.
            </p>
