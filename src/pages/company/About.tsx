          ...
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 text-lg mb-6">
                Центр Безопасности данных — это профессиональная команда специалистов по информационной безопасности с более чем 15-летним опытом работы на российском рынке. Мы специализируемся на комплексных решениях по защите информации для коммерческих организаций и государственных структур.
              </p>
