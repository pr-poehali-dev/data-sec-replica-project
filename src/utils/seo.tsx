...
export const SEO_CONFIGS = {
  home: {
    ...
    description: 'ИНФОБЕЗ — профессиональные услуги по защите информации: аттестация, защита персональных данных, аудит ИБ. 15 лет опыта, 100+ проектов. Москва.',
    keywords: 'защита информации, кибербезопасность, аттестация, защита данных, информационная безопасность, ИНФОБЕЗ, Москва',
  },
  ...
  company: {
    about: {
      title: 'О компании ИНФОБЕЗ',
      description: 'ИНФОБЕЗ — 15 лет на рынке информационной безопасности. 100+ завершенных проектов, 50+ постоянных клиентов. Команда сертифицированных специалистов в Москве.',
      keywords: 'о компании, ИНФОБЕЗ, информационная безопасность, партнер, Москва',
      canonicalUrl: `${SITE_URL}/company/about`,
    },
    
    contacts: {
      title: 'Контакты ИНФОБЕЗ',
      description: 'Свяжитесь с ИНФОБЕЗ: +7 (901) 500-00-78, +7 (901) 500-00-87, info@security-center.ru. Офис в Москве: Партийный пер., д. 1. Консультации по ИБ.',
      keywords: 'контакты, телефон, адрес, офис Москва, ИНФОБЕЗ',
