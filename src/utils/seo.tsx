...
export const SEO_CONFIGS = {
  home: {
    ...
    description: 'Комплексные услуги по защите информации: аттестация, защита персональных данных, средства информационной безопасности. Официальный партнер ведущих производителей.',
    keywords: 'защита информации, кибербезопасность, аттестация, защита данных, информационная безопасность, КиифСтэк',
  },
  ...
  company: {
    about: {
      title: 'О компании КиифСтэк',
      description: 'Лидер рынка информационной безопасности с 2008 года. Более 500 завершенных проектов. Команда сертифицированных специалистов. Официальный партнер ведущих вендоров.',
      keywords: 'о компании, КиифСтэк, информационная безопасность, партнер',
      canonicalUrl: `${SITE_URL}/company/about`,
    },
    
    contacts: {
      title: 'Контакты',
      description: 'Свяжитесь с нами: +7 (901) 500-00-78, info@security-center.ru. Офис в Москве, Партийный пер., д. 1. Консультации по информационной безопасности.',
      keywords: 'контакты, телефон, адрес, офис Москва',
